...
export function HeaderAdmin() {
    ...
    return (
        <header className="bg-unitali-blue-700 w-full max-w-2xl md:max-w-none mx-auto px-2 py-2 md:p-4 flex justify-between items-center top-0 left-0 z-50 fixed">
