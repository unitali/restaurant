    ...
    return (
        <div className="relative flex-1 mb-2">
            ...
            <input
                ...
                id={`input-${props.id}`}
                type={inputType}
                className={`w-full p-4 pt-5 rounded ${props.disabled ? "bg-gray-100 text-gray-400 hover:cursor-not-allowed" : "bg-white text-gray-900"} border focus:outline-none focus:ring-2  ${isRequiredError ? "border-red-500 focus:ring-red-500" : "border-teal-500 focus:ring-teal-500"}`}
                onBlur={(e) => {
                    setTouched(true);
